...
@section('page-actions')
    <div class="btn-group" role="group" style="gap: 0.5rem;">
        ...
        <!-- <a href="{{ route('admin.categories.edit', $category) }}" class="btn btn-t-g fw-medium px-4">
        ...
        <div class="koa-view-card">
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap">
                    <div>
                        <h2 class="mb-1 text-dark fw-bold">
                            <i class="fas fa-tag text-green me-2"></i>{{ $category->name }}
                        </h2>
            ...
            <div class="koa-view-body">
                ...
                <div class="row">
                    ...
                    <div class="{{ $category->Image ? 'col-lg-8' : 'col-lg-12' }}">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="koa-info-card">
                                    <div class="koa-info-label">
                            ...
                            <div class="col-md-6">
                                <div class="koa-info-card">
                                    ...
                                    <div class="koa-info-value">
                                        ...
                                        @else
                                            <div class="koa-status-badge" style="background-color: #fff5f5; border: 1px solid #fecaca; color: #dc2626;">
                            ...
                            <div class="koa-info-value">
                                ...
                                <div class="koa-meta-info mt-2">
                                    <small class="text-muted">
                                        ...
                                        {{ $category->created_at->format('l, F j, Y \a\t g:i A') }}
                                    </small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="koa-info-card">
                            ...
                            <div class="koa-info-value">
                                ...
                                <div class="koa-meta-info mt-2">
                                    <small class="text-muted">
                                        <i class="fas fa-info-circle me-1"></i>
                                        {{ $category->updated_at->format('l, F j, Y \a\t g:i A') }}
                                    </small>
                                </div>
                            </div>
                        </div>
            ...
            <!-- <div class="koa-view-actions">
                <a href="{{ route('admin.categories.edit', $category) }}" class="koa-btn-edit">
                    <i class="fas fa-edit me-2"></i>Edit Category
                </a>
