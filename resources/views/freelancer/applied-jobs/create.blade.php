        ...
        <div class="elementor-element elementor-element-ce49e7c e-con-full e-flex e-con e-parent" data-id="ce49e7c" data-element_type="container">
            <div class="elementor-element elementor-element-c34158d e-flex e-con-boxed e-con e-child" data-id="c34158d" data-element_type="container" data-settings='{"background_background":"gradient"}'>
                {{-- <div class="e-con-inner">
                    <div class="elementor-element elementor-element-138b985 elementor-position-right elementor-widget__width-auto elementor-mobile-position-right elementor-vertical-align-top animated-fast elementor-view-default elementor-widget elementor-widget-icon-box" data-id="138b985" data-element_type="widget" data-settings='{"_animation":"fadeIn","_animation_delay":50}' data-widget_type="icon-box.default">
                        <div class="elementor-widget-container">
                            <div class="elementor-icon-box-wrapper">
                                ...
                                <div class="elementor-icon-box-content">
                                    <h6 class="elementor-icon-box-title"><span>Apply Now</span></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="elementor-element elementor-element-a1134ac e-flex e-con-boxed e-con e-parent" data-id="a1134ac" data-element_type="container">
                            <div class="e-con-inner">
                                ...
                                <div class="alert alert-warning alert-dismissible fade show mb-4" role="alert">
                                    ...
                                    <a href="{{ route('freelancer.applied-jobs.index') }}" class="alert-link">View your applications</a>
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                </div>
                                @endif

                                <!-- SINGLE FORM START -->
                                <form method="POST" action="{{ route('freelancer.applied-jobs.store') }}" enctype="multipart/form-data" @if($alreadyApplied) onsubmit="event.preventDefault(); alert('You have already applied for this job!'); return false;" @endif>
                                    @csrf
                                    ...
                                    <div class="container">
                                        <div class="row">
                                                        ...
                                                        <div class="row mb-4">
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="tel" class="form-control @error('phone') is-invalid @enderror"
                                                                    id="phone" name="phone" value="{{ Auth::user()->phone }}" readonly>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <select class="form-select @error('employment_type_preference') is-invalid @enderror"
                                                                    ...
                                                                    <option value="{{ $key }}" {{ old('employment_type_preference') == $key ? 'selected' : '' }}>{{ $label }}</option>
                                                                    @endforeach
                                                                </select>
                                                                @error('employment_type_preference') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                                            </div>
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                @error('available_start_date') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 mb-3">
                                                                ...
                                                                <select class="form-select @error('expected_salary_type') is-invalid @enderror"
                                                                    ...
                                                                    <option value="{{ $key }}" {{ old('expected_salary_type', 'hourly') == $key ? 'selected' : '' }}>Per {{ $label }}</option>
                                                                    @endforeach
                                                                </select>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <select class="form-select @error('referral_source') is-invalid @enderror"
                                                                    ...
                                                                    <option value="job_board" {{ old('referral_source') == 'job_board' ? 'selected' : '' }}>Job Board</option>
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <textarea class="form-control @error('additional_comments') is-invalid @enderror"
                                                                    id="additional_comments" name="additional_comments" rows="3"
                                                                    placeholder="Any additional information you would like to provide...">{{ old('additional_comments') }}</textarea>
                                                                @error('additional_comments') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                                            </div>
                                            ...
                                            <div class="col-12 mt-4">
                                                <div class="card shadow-sm border-0 koa-tb-card" style="background-color: #f4f6f0;">
                                                    <div class="card-header border-0 koa-card-header" style="background-color: #e9f8d5;">
                                                        <h5 class="card-title">Preferences & Consent</h5>
                                                    </div>
                                                    <div class="card-body p-4 koa-tb-cnt">
                                                        <div class="form-check mb-3">
                                                            <input class="form-check-input" type="checkbox" name="willing_to_relocate" id="willing_to_relocate"
                                                                value="1" {{ old('willing_to_relocate') ? 'checked' : '' }}>
                                                        ...
                                                        <div class="form-check mb-3 ">
                                                            <input class="form-check-input" type="checkbox" name="has_transportation" id="has_transportation"
                                                                value="1" {{ old('has_transportation') ? 'checked' : '' }}>
                                                        ...
                                                        <div class="form-check mb-3">
                                                            <input class="form-check-input" type="checkbox" name="consent_background_check" id="consent_background_check"
                                                                value="1" {{ old('consent_background_check') ? 'checked' : '' }}>
                                                            <label class="form-check-label" for="consent_background_check">
                                            ...
                                            <div class="col-12 mt-4 text-center">
                                                @if($alreadyApplied)
                                                    ...
                                                    <div class="mt-2">
                                                        <a href="{{ route('freelancer.applied-jobs.index') }}" class="btn btn-outline-primary">
