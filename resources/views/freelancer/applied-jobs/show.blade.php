        ...
        <div class="card shadow-sm border-0 koa-tb-card mb-4">
            ...
            <div class="card-body p-4 koa-tb-cnt">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <strong class="text-muted">Profile Photo:</strong><br>
                        <img src="{{ asset('storage/' . $candidate->profile_photo_path) }}" alt="Profile Photo" class="img-thumbnail" style="max-width: 100px; max-height: 100px;">
                    </div>
                    @endif
                </div>
            </div>
            ...
            <div class="card-body p-4 koa-tb-cnt">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <span class="text-dark">{{ ucwords(str_replace('_', ' ', $candidate->employment_type_preference)) }}</span>
                    </div>
                    @endif
    ...
    <div class="col-lg-4">
        ...
        <div class="card shadow-sm border-0 koa-tb-card mb-4">
            ...
            <div class="card-body p-3 koa-tb-cnt text-center">
                <img src="{{ asset('storage/' . $candidate->profile_photo_path) }}" alt="Profile Photo" class="img-fluid rounded-circle" style="max-width: 150px; max-height: 150px;">
            </div>
        </div>
        @endif
        ...
        <div class="card shadow-sm border-0 koa-tb-card mb-4">
            ...
            <div class="card-body p-3 koa-tb-cnt">
                <div class="mb-2">
                    <i class="fas fa-{{ $candidate->willing_to_relocate ? 'check text-green' : 'times text-muted' }} me-2"></i>
                    <span>Willing to relocate</span>
                </div>
                <div class="mb-2">
                    <i class="fas fa-{{ $candidate->has_transportation ? 'check text-green' : 'times text-muted' }} me-2"></i>
                    <span>Has reliable transportation</span>
                </div>
                <div>
                    <i class="fas fa-{{ $candidate->background_check_consent ? 'check text-green' : 'times text-muted' }} me-2"></i>
