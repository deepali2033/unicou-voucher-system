...
@section('page-actions')
    <a href="{{ route('freelancer.jobs.create') }}" class="btn btn-t-y">
                ...
                <div class="card-body p-4 koa-tb-cnt">
                                ...
                                <tbody>
                                    @foreach($jobs as $job)
                                        <tr style="transition: background-color 0.2s;">
                                            ...
                                            <td>
                                                <form action="{{ route('freelancer.jobs.toggle-status', $job) }}" method="POST"
                                                    class="d-inline">
                                                    @csrf
                                                    @method('PATCH')
                                                    <button type="submit"
                                            ...
                                            <td>
                                                <form action="{{ route('freelancer.jobs.toggle-featured', $job) }}" method="POST"
                                                    class="d-inline">
                                                    @csrf
                                                    @method('PATCH')
                                                    <button type="submit"
                                            ...
                                            <td class="text-end pe-4">
                                                <div class="btn-group" role="group" style="gap: 8px;">
                                                    ...
                                                    <a href="{{ route('freelancer.jobs.edit', $job) }}"
                                                        class="btn btn-sm rounded-circle action-btns koa-badge-green" title="Edit">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <form action="{{ route('freelancer.jobs.destroy', $job) }}" method="POST"
                                                        class="d-inline"
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <a href="{{ route('freelancer.jobs.create') }}" class="btn fw-medium px-4 py-2"
