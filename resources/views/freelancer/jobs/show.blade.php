...
@section('page-actions')
    ...
    <a href="{{ route('freelancer.jobs.edit', $job) }}" class="btn btn-t-y">
        <i class="fas fa-edit me-1"></i> Edit Job
    </a>
    <form action="{{ route('freelancer.jobs.destroy', $job) }}" method="POST" class="d-inline"
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="card shadow-sm border-0 koa-tb-card mt-3" style="background-color: #f4f6f0;">
                ...
                <div class="card-body p-4 koa-tb-cnt">
                    <form action="{{ route('freelancer.jobs.toggle-status', $job) }}" method="POST" class="mb-2">
                        @csrf
                        @method('PATCH')
                        <button type="submit"
