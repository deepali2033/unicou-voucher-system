...
@section('content')
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <div class="d-grid">
                                <a href="{{ route('freelancer.services.create') }}" class="btn btn-primary btn-lg">
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="d-grid">
                                <a href="{{ route('freelancer.services.index') }}" class="btn btn-outline-primary btn-lg">
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="d-grid">
                                <a href="{{ route('freelancer.jobs.create') }}" class="btn btn-success btn-lg">
                                    <i class="fas fa-plus me-2"></i>
                                    Add New Job
                                </a>
                            </div>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="d-grid">
                                <a href="{{ route('freelancer.jobs.index') }}" class="btn btn-outline-success btn-lg">
    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Welcome to KOA Services freelancer Panel</h3>
                </div>
                <div class="card-body">
                    <p class="card-text">
                        Welcome to your freelancer dashboard! Here you can manage all aspects of your cleaning services business.
                    </p>
