...
@section('page-actions')
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group me-2">
            <a href="{{ route('freelancer.candidates.create') }}" class="btn btn-sm btn-outline-secondary">
...
<div class="row">
    <div class="col-12">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form method="GET" action="{{ route('freelancer.candidates.index') }}" class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('freelancer.candidates.index') }}" class="btn btn-outline-secondary">
                                    ...
                                    <tr>
                                                ...
                                                <ul class="dropdown-menu">
                                                    @foreach(['pending', 'under_review', 'interviewed', 'accepted', 'rejected'] as $status)
                                                        @if($status !== $candidate->status)
                                                            <li>
                                                                <form method="POST" action="{{ route('freelancer.candidates.update-status', $candidate) }}" class="d-inline">
                                                                    @csrf
                                                                    @method('PATCH')
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="{{ route('freelancer.candidates.show', $candidate) }}" 
                                                   class="btn btn-sm btn-outline-primary" title="View">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="{{ route('freelancer.candidates.edit', $candidate) }}" 
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        @if(request()->hasAny(['status', 'position', 'search']))
                            <a href="{{ route('freelancer.candidates.index') }}" class="btn btn-outline-primary">
...
function confirmDelete(candidateId) {
    ...
    form.action = `/freelancer/candidates/${candidateId}`;
