...
@section('title', 'Edit Candidate - ' . $candidate->full_name)
@section('page-title', 'Edit Candidate')

@section('page-actions')
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group me-2">
            <a href="{{ route('freelancer.candidates.show', $candidate) }}" class="btn btn-sm btn-outline-primary">
                <i class="fas fa-eye"></i> View
            </a>
            <a href="{{ route('freelancer.candidates.index') }}" class="btn btn-sm btn-outline-secondary">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Edit Candidate: {{ $candidate->full_name }}</h5>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('freelancer.candidates.update', $candidate) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control @error('date_of_birth') is-invalid @enderror" 
                                   id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth', $candidate->date_of_birth?->format('Y-m-d')) }}">
                            @error('date_of_birth')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" id="status" name="status">
                                ...
                                <option value="under_review" {{ old('status', $candidate->status) == 'under_review' ? 'selected' : '' }}>Under Review</option>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control @error('work_experience') is-invalid @enderror" 
                                      ...
                                      placeholder="Please describe relevant work experience...">{{ old('work_experience', $candidate->work_experience) }}</textarea>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control @error('education') is-invalid @enderror" 
                                      ...
                                      placeholder="Please describe educational background...">{{ old('education', $candidate->education) }}</textarea>
                            @error('education')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @if($candidate->resume_path)
                                <div class="mb-2">
                                    ...
                                    <a href="{{ route('freelancer.candidates.download-resume', $candidate) }}" class="text-primary">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @if($candidate->cover_letter_path)
                                <div class="mb-2">
                                    <small class="text-muted">Current: </small>
                                    <a href="{{ route('freelancer.candidates.download-cover-letter', $candidate) }}" class="text-primary">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control @error('additional_notes') is-invalid @enderror" 
                                      ...
                                      placeholder="Any additional information...">{{ old('additional_notes', $candidate->additional_notes) }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a href="{{ route('freelancer.candidates.show', $candidate) }}" class="btn btn-outline-secondary">
