...
@section('page-actions')
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group me-2">
            <a href="{{ route('freelancer.candidates.edit', $candidate) }}" class="btn btn-sm btn-outline-primary">
                <i class="fas fa-edit"></i> Edit
            </a>
            @if($candidate->resume_path)
                <a href="{{ route('freelancer.candidates.download-resume', $candidate) }}" class="btn btn-sm btn-outline-info">
                    <i class="fas fa-download"></i> Resume
                </a>
            @endif
            @if($candidate->cover_letter_path)
                <a href="{{ route('freelancer.candidates.download-cover-letter', $candidate) }}" class="btn btn-sm btn-outline-info">
...
<div class="row">
                ...
                <div class="row">
                    ...
                    @if($candidate->jobListing)
                        <div class="col-md-6 mb-3">
                            ...
                            <a href="{{ route('freelancer.jobs.show', $candidate->jobListing) }}" class="text-primary">
    ...
    <div class="col-lg-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('freelancer.candidates.update-status', $candidate) }}">
                    @csrf
                    @method('PATCH')
                    <div class="mb-3">
        ...
        @if($candidate->resume_path || $candidate->cover_letter_path)
            <div class="card mb-4">
                ...
                <div class="card-body">
                    @if($candidate->resume_path)
                        <div class="mb-2">
                            <a href="{{ route('freelancer.candidates.download-resume', $candidate) }}" 
                    ...
                    @if($candidate->cover_letter_path)
                        <div class="mb-2">
                            <a href="{{ route('freelancer.candidates.download-cover-letter', $candidate) }}" 
                               class="btn btn-outline-primary btn-sm w-100">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    ...
                    @endif
                    <a href="{{ route('freelancer.candidates.edit', $candidate) }}" class="btn btn-outline-primary btn-sm">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form method="POST" action="{{ route('freelancer.candidates.destroy', $candidate) }}" class="d-inline">
                    @csrf
                    @method('DELETE')
