...
@section('page-actions')
    <a href="{{ route('freelancer.services.create') }}" class="btn btn-t-y">
        ...
        <div class="card-body p-4 koa-tb-cnt">
                        ...
                        <tbody>
                            @foreach($services as $service)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('freelancer.services.toggle-status', $service) }}" method="POST"
                                            class="d-inline">
                                            @csrf
                                            @method('PATCH')
                                            <button type="submit"
                                    ...
                                    <td>
                                        <form action="{{ route('freelancer.services.toggle-featured', $service) }}" method="POST"
                                            class="d-inline">
                                            @csrf
                                            @method('PATCH')
                                            <button type="submit"
                                    ...
                                    <td class="text-end pe-4">
                                        <div class="btn-group" role="group" style="gap: 8px;">
                                            ...
                                            <form action="{{ route('freelancer.services.destroy', $service) }}" method="POST"
                                                class="d-inline"
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <a href="{{ route('freelancer.services.create') }}" class="btn fw-medium px-4 py-2"
                                ...
                                <tbody>
                                    @foreach($services as $service)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('freelancer.services.toggle-status', $service) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('PATCH')
                                            ...
                                            <td>
                                                <form action="{{ route('freelancer.services.toggle-featured', $service) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('PATCH')
                                            ...
                                            <td class="table-actions">
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <form action="{{ route('freelancer.services.destroy', $service) }}" 
