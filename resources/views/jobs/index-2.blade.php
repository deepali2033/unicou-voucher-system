...
@section('content')
    <article id="post-2989" class="full post-2989 page type-page status-publish has-post-thumbnail hentry">
        <div data-elementor-type="single-page" data-elementor-id="3145"
            class="elementor elementor-3145 margin-set elementor-location-single post-2989 page type-page status-publish has-post-thumbnail hentry"
                    ...
                    <div data-rocket-location-hash="0bb8abef3c1cf4f2f6dc378583b295e5" class="e-con-inner">
                        ...
                        <div class="elementor-element text-center elementor-element-6ac1097 animated-fast elementor-invisible elementor-widget elementor-widget-theme-post-excerpt"
                            ...
                            {{-- <span
                                ...
                                Find Flexible Work in the Netherlands
                            </span> --}}
                            <div class="elementor-widget-container">
                                Find Flexible Work in the Netherlands </div>
            ...
            {{-- <div class="elementor-element elementor-element-bf6c96a e-flex e-con-boxed e-con e-parent"
                data-id="bf6c96a" data-element_type="container">
                    ...
                    <div class="elementor-widget-container">
                        <div data-elementor-type="wp-page" data-elementor-id="2989" class="elementor elementor-2989"
                            ...
                            <div class="container mx-auto py-16">
                                ...
                                <div class="jobs-search-container">
                                    <div class="search-inputs-row">
                                        <div class="search-input-group">
                                            ...
                                            <input id="job-title-search" type="text" name="title"
                                        ...
                                        <div class="search-input-group">
                                            ...
                                            <input id="job-location-search" type="text" name="location"
                                                placeholder="e.g. Amsterdam, Rotterdam" autocomplete="off" />
                                            <div class="location-suggestions" id="locationSuggestions"></div>
                                        </div>

                                        <div class="search-input-group">
                                            <label for="job-distance-filter" >Distance (km)</label>
                                            <select id="job-distance-filter" class="p-2" name="distance">
                                        ...
                                        <button type="button" id="job-search-button" class="search-button text-white">Search</button>
                                    </div>
                                </div>
                                ...
                                @else
                                    <a href="{{ route('login') }}" class="job-modal__apply"
                                        style="">
                                        <i class="fa-solid fa-paper-plane" style="margin-right: 8px;"></i>Apply Now
                                    </a>
                                @endif
