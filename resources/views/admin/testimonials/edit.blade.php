            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('admin.testimonials.update', $testimonial) }}" method="POST"
                        enctype="multipart/form-data" class="full-width-form">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-text text-muted">
                                        <i class="fas fa-info-circle me-1"></i>Optional: Customer's job title or
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('content') is-invalid @enderror" id="content"
                                name="content" rows="5"
                                placeholder="Enter the customer's testimonial/review...">{{ old('content', $testimonial->content) }}</textarea>
                            @error('content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @enderror
                                    <div class="form-text text-muted">
                                        <i class="fas fa-star me-1"></i>Optional: Customer's star rating out of 5
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @if($testimonial->image)
                                        <div class="current-image mb-2">
                                            <img src="{{ asset('storage/' . $testimonial->image) }}"
                                                alt="Current Customer Photo" class="img-fluid rounded"
                                        ...
                                        <div class="form-text text-success mb-2">
                                            <i class="fas fa-check-circle me-1"></i>Current photo. Upload a new one to replace
                                            it.
                                        </div>
                                    @endif

                                    <div id="image-preview-container" class="mb-2" style="display: none;">
                                        <img id="image-preview" src="" alt="New Photo Preview"
                                            class="img-fluid rounded image-preview-enhanced"
                                            style="width: 120px; height: 120px; object-fit: cover;">
                                        <div class="form-text text-success">
                                            <i class="fas fa-check-circle me-1"></i>New photo preview
                                        </div>
                                    </div>
                                    ...
                                    @enderror
                                    <div class="form-text text-muted">
                                        <i class="fas fa-info-circle me-1"></i>Upload new customer photo (JPEG, PNG, JPG,
                                        GIF - Max: 2MB)
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-text text-muted">
                                        <i class="fas fa-eye-slash me-1"></i>Inactive testimonials will not be displayed on
                                        the website
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function removeCurrentImage() {
            if (confirm('Are you sure you want to remove the current image? This action cannot be undone.')) {
                // Create a hidden input to indicate image should be removed
