        ...
        <div class="col-12">
            <div class="card shadow-sm border-0">
                <div class="card-header">
                    <h4 class="mb-0">Testimonial Information</h4>
                </div>
                    ...
                    <form action="{{ route('admin.testimonials.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                        name="name" value="{{ old('name') }}" placeholder="e.g., John Smith" required>
                                    @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('content') is-invalid @enderror" id="content"
                                name="content" rows="5"
                                placeholder="Enter the customer's testimonial/review...">{{ old('content') }}</textarea>
                            @error('content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div id="image-preview-container" class="mb-2" style="display: none;">
                                        <img id="image-preview" src="" alt="Customer Photo Preview"
                                            class="img-fluid rounded image-preview-enhanced"
                                            style="width: 120px; height: 120px; object-fit: cover;">
                                        <div class="form-text text-success">
                                            <i class="fas fa-check-circle me-1"></i>Photo preview
                                        </div>
                                    </div>
                                    ...
                                    @enderror
                                    <div class="form-text text-muted">
                                        <i class="fas fa-info-circle me-1"></i>Upload customer photo (JPEG, PNG, JPG, GIF -
                                        Max: 2MB)
                                    </div>
                                </div>
                            </div>
