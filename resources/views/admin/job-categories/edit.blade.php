...
@section('page-title', 'Edit Category: ' . $jobCategory->name)
            ...
            <div class="koa-edit-card">
                ...
                <form action="{{ route('admin.job-categories.update', $jobCategory) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="koa-form-group">
                                    ...
                                    <input type="text"
                                        class="form-control koa-form-control @error('name') is-invalid @enderror" id="name"
                                ...
                                <div class="koa-form-group">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active"
                                            value="1" {{ old('is_active', $jobCategory->is_active ?? true) ? 'checked' : '' }}
                                            style="background-color: {{ old('is_active', $jobCategory->is_active ?? true) ? '#3ca200' : '' }}; border-color: #3ca200;">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="koa-form-group">
                                    ...
                                    <textarea
                                        class="form-control koa-form-control koa-textarea @error('description') is-invalid @enderror"
                                        id="description" name="description"
                                        placeholder="Provide a brief description of this category to help users understand its purpose...">{{ old('description', $jobCategory->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted mt-2 d-block">
                            ...
                            <div class="col-md-4">
                                <div class="koa-form-group">
                                    ...
                                    @if($jobCategory->image)
                                        <div class="mb-3">
                                            <img src="{{ asset($jobCategory->image) }}" alt="Current category image"
                                    ...
                                    <input type="file"
                                        class="form-control koa-form-control @error('image') is-invalid @enderror"
                    ...
                    <div class="koa-form-actions">
                        <a href="{{ route('admin.job-categories.index') }}" class="koa-btn-cancel">
