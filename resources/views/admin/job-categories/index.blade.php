...
@section('page-title', '  Job Categories Management')

@section('page-actions')
    <a href="{{ route('admin.job-categories.create') }}" class="btn btn-t-g">
        <i class="fas fa-plus me-2"></i>Add New Job Category
    </a>
@endsection
...
@section('content')
    <div class="card shadow-sm border-0 koa-tb-card">
        ...
        <div class="card-body border-bottom p-4" style="background-color: #f8f9fa;">
            <form method="GET" action="{{ route('admin.job-categories.index') }}" class="row g-3">
                <div class="col-md-8">
                    <div class="input-group">
                        ...
                        <input type="text" name="search" class="form-control border-start-0"
                            placeholder="Search categories by name..." value="{{ request('search') }}"
                                ...
                                <tr>
                                    ...
                                    <td class="text-end pe-4">
                                        <div class="btn-group" role="group" style="gap: 8px;">
                                            <a href="{{ route('admin.job-categories.show', $category) }}"
                ...
                <div class="text-center py-5">
                    @if(request('search'))
                        ...
                        <p class="text-muted">
                            ...
                            <a href="{{ route('admin.job-categories.index') }}" class="text-decoration-none">clear all filters</a>
                        </p>
                    @else
                        ...
                        <a href="{{ route('admin.job-categories.create') }}" class="btn fw-medium px-4 py-2"
                            style="background-color: #3ca200; color: #fff;">
                            <i class="fas fa-plus me-2"></i>Add Your First Job Category
                        </a>
                    @endif
                </div>
            @endif
