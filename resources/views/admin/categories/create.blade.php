    ...
    <div class="col-12">
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body p-4">
                <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data" class="full-width-form">
                    @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-text text-muted">
                                    <i class="fas fa-info-circle me-1"></i>Upload an image for this category (JPEG, PNG, JPG, GIF - Max: 2MB)
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-text text-muted">
                                    <i class="fas fa-eye-slash me-1"></i>Inactive categories will not be visible to users
                                </div>
                            </div>
                        </div>
                    </div>
