...
@section('page-actions')
    <a href="{{ route('admin.applied-jobs.create') }}" class="btn btn-t-g">
...
@section('content')
    <div class="card shadow-sm border-0 koa-tb-card">
        <div class="card-header border-0">
            ...
            <!-- Filters Section -->
            <div class="p-3 pt-0">
                <form method="GET" action="{{ route('admin.applied-jobs.index') }}" class="row g-3">
                    <div class="col-md-4">
                    ...
                    @if(request()->hasAny(['search', 'status', 'position']))
                        <div class="col-12">
                            <a href="{{ route('admin.applied-jobs.index') }}" class="btn btn-sm btn-outline-secondary">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end pe-4">
                                        <div class="btn-group" role="group" style="gap: 8px;">
                                            <a href="{{ route('admin.applied-jobs.show', $candidate) }}"
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        @if(request()->hasAny(['search', 'status', 'position']))
                            <a href="{{ route('admin.applied-jobs.index') }}" class="btn btn-outline-secondary px-4 py-2">
                                <i class="fas fa-times me-2"></i>Clear Filters
                            </a>
                        @endif
                        <a href="{{ route('admin.applied-jobs.create') }}" class="btn fw-medium px-4 py-2"
