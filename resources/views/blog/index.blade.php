...
@section('title', 'Blog - CleanyCo')
@section('meta_description', 'Read cleaning tips, hacks, and company updates on the CleanyCo blog.')

@section('content')
    <section class="page-header margin-set ">
        <div class="container">
            <div class="page-header-content text-center">
                <h1>Blog</h1>
                <p>Cleaning tips, hacks and updates</p>
            </div>
        </div>
    </section>
            ...
            <div class="elementor-element elementor-element-b90e2ae e-con-full e-flex e-con e-parent" data-id="b90e2ae"
                ...
                <div class="elementor-element elementor-element-b9a1620 e-flex e-con-boxed e-con e-child" data-id="b9a1620"
                    ...
                    <div class="e-con-inner">
                                    ...
                                    @if($blogs->count() > 0)
                                        @foreach ($blogs as $blog)
                                            <div data-elementor-type="loop-item" data-elementor-id="958"
                                                class="elementor elementor-958 e-loop-item e-loop-item-943 post-943 post type-post status-publish format-standard has-post-thumbnail hentry category-organizing tag-cleaning-tips"
                                                data-elementor-post-type="elementor_library" data-custom-edit-handle="1">
                                                <div class="elementor-element elementor-element-4f1e9c1 e-con-full animated-fast e-flex elementor-invisible e-con e-parent"
                                                    data-id="4f1e9c1" data-element_type="container"
                                                    data-settings="{&quot;animation&quot;:&quot;fadeIn&quot;,&quot;animation_delay&quot;:200}">
                                                    <div class="elementor-element elementor-element-06448ff elementor-widget elementor-widget-theme-post-featured-image elementor-widget-image"
                                                        data-id="06448ff" data-element_type="widget"
                                                        data-widget_type="theme-post-featured-image.default">
                                                        <div class="elementor-widget-container">
                                                            <a href="#">
                                                                <img loading="lazy" decoding="async" width="400" height="250"
                                                                    src="{{ asset($blog->featured_image) }}"
                                                                    class="attachment-large size-large wp-image-944"
                                                    ...
                                                    <div class="elementor-element elementor-element-3f74ba9 elementor-widget elementor-widget-post-info"
                                                        data-id="3f74ba9" data-element_type="widget"
                                                        data-widget_type="post-info.default">
                                                        <div class="elementor-widget-container">
                                                            <ul
                                                                class="elementor-inline-items elementor-icon-list-items elementor-post-info">
                                                                <li class="elementor-icon-list-item elementor-repeater-item-3d8ad79 elementor-inline-item"
                                                                    itemprop="about">
                                                                    <span
                                                    ...
                                                    <div class="elementor-element elementor-element-45cb3ce elementor-widget elementor-widget-theme-post-title elementor-page-title elementor-widget-heading"
                                                        data-id="45cb3ce" data-element_type="widget"
                                                        data-widget_type="theme-post-title.default">
                                                        <div class="elementor-widget-container">
                                                            <h4 class="elementor-heading-title elementor-size-default">
                                                                <a href="#">{{ Str::limit($blog->short_description, 60) }}</a>
                                                            </h4>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        {{-- <div
                            class="vamtam-has-theme-widget-styles elementor-element elementor-element-37af0b6 elementor-align-center animated-fast vamtam-has-hover-anim elementor-invisible elementor-widget elementor-widget-button"
                            data-id="37af0b6" data-element_type="widget"
