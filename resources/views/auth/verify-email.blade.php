...
@section('title', 'Verify Email - KAO services')
@section('meta_description', 'Please verify your email address to continue.')

@section('content')
    <div class="auth-container">
        <h2 class="text-center mt-2 mb-4">Verify your email</h2>
        ...
        <p class="mb-4">Thanks for signing up! Before getting started, please verify your email address by clicking on the link we just emailed to you. If you didn't receive the email, we will gladly send you another.</p>
...
<link rel='stylesheet' id='elementor-post-66-css' href='{{ asset("wp-content/uploads/elementor/css/post-66.css") }}?ver=1752678329' type='text/css' media='all'>
...
<link rel='stylesheet' id='elementor-post-3145-css' href='{{ asset("wp-content/uploads/elementor/css/post-3145.css") }}?ver=1752677976' type='text/css' media='all'>
