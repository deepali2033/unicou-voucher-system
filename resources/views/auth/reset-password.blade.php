...
@section('title', 'Reset Password - KAO services for Professional Cleaning Services')
@section('meta_description', 'Reset your KAO services account password. Enter your email and new password to complete the reset.')

@section('content')
    <div class="auth-container">
        <h2 class="text-center mt-2 mb-4">Reset Password</h2>
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="mb-3">
                ...
                <input name="email" type="email" class="form-control" id="email" value="{{ old('email', $email ?? '') }}" placeholder="Enter your email" required>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col">
                    ...
                    <div class="password-container">
                        <input name="password_confirmation" type="password" class="form-control" id="password_confirmation" placeholder="Confirm new password" required>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            // Password toggle functionality (works for any .password-toggle)
