...
<div class="btn-toolbar" role="toolbar">
    <div class="btn-group me-2" role="group">
        ...
        <!-- <a href="{{ route('user.book-services.edit', $bookService) }}" class="btn btn-warning">
    ...
    <div class="col-lg-4">
        ...
        <div class="koa-tb-card mb-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('user.book-services.update-status', $bookService) }}" method="POST">
                    @csrf
                    @method('PATCH')
