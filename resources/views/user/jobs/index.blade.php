...
@section('page-actions')
    <a href="{{ route('user.jobs.create') }}" class="btn btn-t-y">
                ...
                <div class="card-body p-4 koa-tb-cnt">
                                ...
                                <tbody>
                                    @foreach($jobs as $job)
                                        <tr style="transition: background-color 0.2s;">
                                            ...
                                            <td>
                                                <form action="{{ route('user.jobs.toggle-status', $job) }}" method="POST"
                                                    class="d-inline">
                                                    @csrf
                                                    @method('PATCH')
                                                    <button type="submit"
                                            ...
                                            <td>
                                                <form action="{{ route('user.jobs.toggle-featured', $job) }}" method="POST"
                                                    class="d-inline">
                                                    @csrf
                                                    @method('PATCH')
                                                    <button type="submit"
                                            ...
                                            <td class="text-end pe-4">
                                                <div class="btn-group" role="group" style="gap: 8px;">
                                                    ...
                                                    <form action="{{ route('user.jobs.destroy', $job) }}" method="POST"
                                                        class="d-inline"
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <a href="{{ route('user.jobs.create') }}" class="btn fw-medium px-4 py-2"
