...
@section('page-actions')
    <div class="d-flex gap-2">
        ...
        @endif
        <form action="{{ route('user.notifications.delete-all-read') }}" method="POST" class="d-inline"
            ...
            @if($notifications->isEmpty())
                <div class="text-center py-5">
                    <div class="notification-icon mx-auto mb-3"
                        style="background-color: #f8f9fa; width: 80px; height: 80px; font-size: 2rem;">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <div class="notification-icon {{ $notification->badge_color }} bg-opacity-10">
                                            <i
                                                class="{{ $notification->icon }} {{ str_replace('bg-', 'text-', $notification->badge_color) }}"></i>
                                        </div>
                                    </div>
                                    <div class="col">
