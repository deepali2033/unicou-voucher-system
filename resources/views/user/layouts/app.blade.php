...
<head>
    ...
    <title>@yield('title', 'User Panel') - KOA Services</title>
            ...
            <nav id="sidebar" class="col-md-3 col-lg-3 sidebar sidebar-hidden">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column gap-2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('user.book-services.*') ? 'active' : '' }}"
                                href="{{ route('user.book-services.index') }}">
                                <i class="fas fa-calendar-check me-2"></i>
                                Book Services
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('user.jobs.*') ? 'active' : '' }}"
