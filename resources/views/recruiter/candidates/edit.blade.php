...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('recruiter.candidates.update', $candidate) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @if($candidate->resume_path)
                                <div class="mb-2">
                                    ...
                                    <a href="{{ route('recruiter.candidates.download-resume', $candidate) }}" class="text-primary">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @if($candidate->cover_letter_path)
                                <div class="mb-2">
                                    <small class="text-muted">Current: </small>
                                    <a href="{{ route('recruiter.candidates.download-cover-letter', $candidate) }}" class="text-primary">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a href="{{ route('recruiter.candidates.show', $candidate) }}" class="btn btn-outline-secondary">
