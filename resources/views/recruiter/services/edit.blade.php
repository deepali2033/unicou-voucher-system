...
<div class="row">
    <div class="col-12">
        <form action="{{ route('recruiter.services.update', $service) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="card shadow-sm border-0 koa-tb-card mt-4" style="background-color: #f4f6f0;">
                <div class="card-body p-4 koa-tb-cnt">
                    <div class="d-flex justify-content-between gap-3">
                        <a href="{{ route('recruiter.services.index') }}" class="btn koa-badge-green-outline fw-medium px-4 py-2">
