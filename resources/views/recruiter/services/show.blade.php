...
@section('page-actions')
    <div class="d-flex gap-2">
        <a href="{{ route('recruiter.services.edit', $service) }}" class="btn btn-t-y">
    ...
    <div class="card shadow-sm border-0 koa-tb-card mt-4 bg-grey">
        ...
        <div class="card-body p-4 koa-tb-cnt">
            <div class="d-grid gap-2">
                ...
                <a href="{{ route('recruiter.services.edit', $service) }}" class="btn fw-medium px-4 py-2 koa-badge-green w-100">
                    <i class="fas fa-edit me-2"></i>Edit Service
                </a>
