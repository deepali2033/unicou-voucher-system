...
@section('page-actions')
    <a href="{{ route('recruiter.services.index') }}" class="btn btn-t-g">
...
@section('content')
    <div class="row">
        <div class="col-12">
            <form action="{{ route('recruiter.services.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="card-body p-4 koa-tb-cnt">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    @error('slug')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div class="form-text text-muted">Used in the URL. Leave empty to auto-generate from
                                        name.</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            @error('short_description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text text-muted">Brief description shown in service listings (max 500
                                characters).</div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('price_from') is-invalid @enderror"
                                        id="price_from" name="price_from" value="{{ old('price_from') }}" min="0"
                                        step="0.01">
                                    @error('price_from')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('price_to') is-invalid @enderror"
                                        id="price_to" name="price_to" value="{{ old('price_to') }}" min="0" step="0.01">
                                    @error('price_to')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('icon') is-invalid @enderror" id="icon"
                                        name="icon" value="{{ old('icon') }}" placeholder="e.g., fas fa-broom">
                                    @error('icon')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    @error('image')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div class="form-text text-muted">Upload an image for this service (JPEG, PNG, JPG, GIF
                                        - Max: 2MB).</div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    @error('meta_description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div class="form-text text-muted">SEO description for search engines (max 500
                                        characters).</div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card shadow-sm border-0 koa-tb-card mt-4" style="background-color: #f4f6f0;">
                    <div class="card-body p-4 koa-tb-cnt">
                        <div class="d-flex justify-content-between gap-3">
                            <a href="{{ route('recruiter.services.index') }}"
