...
@section('page-actions')
    <a href="{{ route('recruiter.services.create') }}" class="btn btn-t-y">
        ...
        <div class="card-body p-4 koa-tb-cnt">
                        ...
                        <tbody>
                            @foreach($services as $service)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('recruiter.services.toggle-status', $service) }}" method="POST"
                                            class="d-inline">
                                            @csrf
                                            @method('PATCH')
                                            <button type="submit"
                                    ...
                                    <td>
                                        <form action="{{ route('recruiter.services.toggle-featured', $service) }}" method="POST"
                                            class="d-inline">
                                            @csrf
                                            @method('PATCH')
                                            <button type="submit"
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <a href="{{ route('recruiter.services.create') }}" class="btn fw-medium px-4 py-2"
                        ...
                        <div class="card-body">
                                        ...
                                        <tbody>
                                            @foreach($services as $service)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="{{ route('recruiter.services.toggle-status', $service) }}" method="POST" class="d-inline">
                                                            @csrf
                                                            @method('PATCH')
                                                    ...
                                                    <td>
                                                        <form action="{{ route('recruiter.services.toggle-featured', $service) }}" method="POST" class="d-inline">
                                                            @csrf
                                                            @method('PATCH')
                                                    ...
                                                    <td class="table-actions">
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <form action="{{ route('recruiter.services.destroy', $service) }}"
                            ...
                            @else
                                <div class="text-center py-5">
                                    ...
                                    <p class="text-muted">Get started by creating your first service.</p>
                                    <a href="{{ route('recruiter.services.create') }}" class="btn btn-primary">
                                        <i class="fas fa-plus me-2"></i>Add Your First Service
                                    </a>
                                </div>
                            @endif
