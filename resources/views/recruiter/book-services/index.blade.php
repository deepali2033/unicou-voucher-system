...
@section('title', 'Booked Services Management')
@section('page-title', 'Booked Services Management')
...
@section('content')
    <div class="card shadow-sm border-0 koa-tb-card">
        ...
        <div class="card-body p-4 koa-tb-cnt">
            ...
            <form method="GET" action="{{ route('recruiter.book-services.index') }}" class="mb-4">
                <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-2">
                        <div class="d-flex gap-2">
                            ...
                            @if(request()->hasAny(['search', 'status']))
                                <a href="{{ route('recruiter.book-services.index') }}" class="btn btn-outline-secondary px-3"
                                    title="Clear filters">
                                ...
                                <tr>
                                    <td>
                                        <div>
                                            ...
                                            @if($booking->phone)
                                                <br>
                                                <small class="badge koa-badge-yellow fw-normal px-2 py-1">
                                                    {{ $booking->phone }}
                                                </small>
                                            @endif
                                        </div>
                                    ...
                                    <td>
                                        <span class="badge fw-normal px-3 py-2
                                                        @if(($booking->status ?? 'pending') === 'pending') koa-badge-yellow
                                                        @elseif($booking->status === 'confirmed') koa-badge-blue
                                                        @elseif($booking->status === 'in_progress') koa-badge-purple
                                                        @elseif($booking->status === 'completed') koa-badge-green
                                                        @elseif($booking->status === 'cancelled') koa-badge-red
                                    ...
                                    <td>
                                        @if($booking->price)
                                            <strong class="text-dark">€{{ number_format($booking->price, 2) }} EUR | 🇳🇱 NL</strong>
                                        @else
                                    ...
                                    <td class="text-end">
                                        <div class="btn-group" role="group" aria-label="Booking actions">
                                            <a href="{{ route('recruiter.book-services.show', $booking) }}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form method="POST"
                                                    action="{{ route('recruiter.book-services.destroy', $booking) }}"
            ...
            @else
                <div class="text-center py-5">
                    ...
                    @if(request()->hasAny(['search', 'status']))
                        ...
                        <a href="{{ route('recruiter.book-services.index') }}" class="btn btn-outline-secondary">
