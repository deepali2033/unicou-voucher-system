                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="mailto:{{ $bookService->email }}"
                                    class="text-primary">{{ $bookService->email }}</a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex align-items-center">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column">
                                ...
                                <span>{{ $bookService->city }}, {{ $bookService->state }}
                                    {{ $bookService->zip_code }}</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="koa-tb-card bg-grey mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('recruiter.book-services.update-status', $bookService) }}" method="POST">
                        @csrf
                        @method('PATCH')
            ...
            <div class="koa-tb-card bg-grey mb-4">
                ...
                <div class="card-body text-center">
                    @if($bookService->price)
                        <h4 class="text-success mb-0">€{{ number_format($bookService->price, 2) }} EUR</h4>
                ...
                <div class="card-body">
                    <div class="timeline">
                        <div class="d-flex flex-column">
                            ...
                            <small
                                class="text-muted ms-4">{{ $bookService->created_at->format('F d, Y \a\t H:i A') }}</small>
                        </div>
                        ...
                        @if($bookService->updated_at != $bookService->created_at)
                            <div class="d-flex flex-column mt-3">
                                ...
                                <small
                                    class="text-muted ms-4">{{ $bookService->updated_at->format('F d, Y \a\t H:i A') }}</small>
                            </div>
                        @endif
                    </div>
                </div>
