...
@section('page-actions')
    ...
    <div class="d-flex gap-2">
        <a href="{{ route('recruiter.jobs.show', $job) }}" class="btn btn-t-y">
            <i class="fas fa-eye me-1"></i> View Job
        </a>
        <a href="{{ route('recruiter.jobs.index') }}" class="btn btn-t-g">
        ...
        <div class="col-12">
            <div class="card shadow-sm border-0 koa-tb-card bg-grey">
                <div class="card-header border-0 koa-card-header">
                    <h5 class="card-title mb-0 text-dark fs-4 py-2">Edit: {{ $job->title }}</h5>
                </div>
                <div class="card-body p-4 koa-tb-cnt">
                    <form action="{{ route('recruiter.jobs.update', $job) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('short_description') is-invalid @enderror"
                                id="short_description" name="short_description" rows="2" maxlength="500"
                                required>{{ old('short_description', $job->short_description) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description"
                                name="description" rows="8" required>{{ old('description', $job->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('employment_type') is-invalid @enderror"
                                        ...
                                        @foreach(App\Models\JobListing::getEmploymentTypes() as $key => $type)
                                            <option value="{{ $key }}" {{ old('employment_type', $job->employment_type) == $key ? 'selected' : '' }}>
                                                {{ $type }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01"
                                        class="form-control @error('salary_min') is-invalid @enderror" id="salary_min"
                                        name="salary_min" value="{{ old('salary_min', $job->salary_min) }}">
                                    @error('salary_min')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01"
                                        class="form-control @error('salary_max') is-invalid @enderror" id="salary_max"
                                        name="salary_max" value="{{ old('salary_max', $job->salary_max) }}">
                                    @error('salary_max')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('salary_type') is-invalid @enderror" id="salary_type"
                                        ...
                                        @foreach(App\Models\JobListing::getSalaryTypes() as $key => $type)
                                            <option value="{{ $key }}" {{ old('salary_type', $job->salary_type) == $key ? 'selected' : '' }}>
                                                {{ $type }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="mb-3">
                            ...
                            <button type="button" class="btn btn-sm koa-badge-yellow" id="add-requirement">
                        ...
                        <div class="mb-3">
                            ...
                            <button type="button" class="btn btn-sm koa-badge-yellow" id="add-benefit">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('sort_order') is-invalid @enderror"
                                        id="sort_order" name="sort_order" value="{{ old('sort_order', $job->sort_order) }}">
                                    @error('sort_order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('meta_title') is-invalid @enderror"
                                        id="meta_title" name="meta_title" value="{{ old('meta_title', $job->meta_title) }}">
                                    @error('meta_title')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-switch">
                                        ...
                                        <input type="checkbox" class="form-check-input" id="is_featured" name="is_featured"
                                            value="1" {{ old('is_featured', $job->is_featured) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('meta_description') is-invalid @enderror"
                                ...
                                maxlength="500">{{ old('meta_description', $job->meta_description) }}</textarea>
                            <div class="form-text text-muted">Maximum 500 characters</div>
                        ...
                        <div class="d-flex justify-content-between gap-3">
                            <a href="{{ route('recruiter.jobs.index') }}"
                                class="btn koa-badge-green-outline fw-medium px-4 py-2">
