    ...
    <div class="col-12">
        <div class="card shadow-sm border-0 koa-tb-card" style="background-color: #f4f6f0;">
            ...
            <div class="card-body p-4 koa-tb-cnt">
                <form action="{{ route('recruiter.jobs.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="d-flex justify-content-between gap-3">
                        <a href="{{ route('recruiter.jobs.index') }}" class="btn koa-badge-green-outline fw-medium px-4 py-2">
