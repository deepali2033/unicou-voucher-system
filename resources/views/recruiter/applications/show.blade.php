...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            <a href="{{ route('recruiter.applications.index') }}" class="btn btn-outline-secondary mb-3">
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('recruiter.applications.destroy', $application) }}"
