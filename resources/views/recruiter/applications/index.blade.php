    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-body">
                    <form method="GET" action="{{ route('recruiter.applications.index') }}" class="row g-3">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-3 d-flex align-items-end">
                            ...
                            <a href="{{ route('recruiter.applications.index') }}" class="btn btn-outline-secondary">Clear</a>
                        </div>
                    </form>
                </div>
            </div>
                    ...
                    <div class="card h-100 shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="mt-3 d-flex justify-content-between">
                                <a href="{{ route('recruiter.applications.show', $application) }}" class="btn btn-primary btn-sm">
                                        ...
                                        <ul class="dropdown-menu">
                                            @foreach($statuses as $key => $label)
                                                @if($key !== $application->status)
                                                    <li>
                                                        <form method="POST" action="{{ route('recruiter.applications.update-status', $application) }}">
                                                            @csrf
                                                            @method('PATCH')
