...
class CandidateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.candidates.index', compact('candidates', 'stats', 'statuses', 'positions'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.candidates.create', compact('jobListings'));
    }
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'status' => 'required|in:pending,under_review,interviewed,accepted,rejected',
            'is_active' => 'boolean',
    ...
    {
        $jobListings = JobListing::active()->ordered()->get();
        return view('admin.candidates.edit', compact('candidate', 'jobListings'));
    }
