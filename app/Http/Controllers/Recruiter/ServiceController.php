...
class ServiceController extends Controller
{
    ...
    {
        // Only current recruiter's services
        $services = Service::where('user_id', auth()->id())
            ->orderBy('sort_order')
            ->orderBy('name')
            ->paginate(15);
        return view('recruiter.services.index', compact('services'))->with('approval_status', $services->pluck('approval_status'));
    }
    ...
    public function create()
    {
        ...
        return view('recruiter.services.create', compact('categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // Attach to current user (recruiter)
        $validated['user_id'] = $request->user()->id;
        $validated['approval_status'] = 'Pending';
        $validated['servicetoggle'] = 'recruiter';
        ...
        return redirect()->route('recruiter.services.index')
    ...
    public function show(Service $service)
    {
        ...
        return view('recruiter.services.show', compact('service'));
    }
    ...
    public function edit(Service $service)
    {
        ...
        $categories = Category::orderBy('name')->get();
        return view('recruiter.services.edit', compact('service', 'categories'));
    }
    ...
    public function update(Request $request, Service $service)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            // Debug: Verify image path update
            \Log::info('Image field before update: ' . $service->image);
            \Log::info('Image field to update: ' . $validated['image']);
        }
