...
$statuses = Candidate::getStatuses();
        ...
        return view('recruiter.candidates.index', compact('candidates', 'stats', 'statuses', 'positions'));
    }
    ...
    public function create()
    {
        ...
        return view('recruiter.candidates.create', compact('jobListings'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('recruiter.candidates.index')
    ...
    {
        $jobListings = JobListing::active()->ordered()->get();
        return view('recruiter.candidates.edit', compact('candidate', 'jobListings'));
    }
