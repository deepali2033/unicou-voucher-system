...
class ReceivedApplicationController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('user.applications.index', compact('applications', 'statuses'));
    }

    public function show(JobApplication $application)
    {
        // Ensure the user can only view applications for their jobs
    ...
    {
        // Ensure the user can only update applications for their jobs
        if ($application->recruiter_id !== Auth::id()) {
            abort(403, 'Unauthorized access to this application.');
        }
    ...
    {
        // Ensure the user can only delete applications for their jobs
        if ($application->recruiter_id !== Auth::id()) {
            abort(403, 'Unauthorized access to this application.');
        }
